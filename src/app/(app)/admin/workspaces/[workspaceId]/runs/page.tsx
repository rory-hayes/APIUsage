...
export default async function AdminWorkspaceRunsPage({ params }: { params: Promise<{ workspaceId: string }> }) {
    ...
    <>
      <div className="flex flex-wrap items-start justify-between gap-6">
        <div>
          ...
          <Heading className="mt-6">Run history</Heading>
          <Text className="mt-2">
            {workspace.organizationName} - {workspace.auditPeriod}. Internal parser and reconciliation runs for this
            workspace.
          </Text>
        </div>
      ...
      {RuleTemplateRunForm({ workspaceId: workspace.id })}
